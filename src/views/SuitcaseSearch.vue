                        ...
                        >
                            ...
                            <div class="take_results_item__info">
                                <div class="take_results_item__list">
                                    <p v-if="item.till">
                                        <span>{{ $vuetify.lang.t('$vuetify.term') }}:</span> {{ item.till }}
                                    </p>

                                    <p v-if="item.weight">
                                        <span>{{ $vuetify.lang.t('$vuetify.weight') }}:</span> {{ item.weight }}
                                    </p>

                                    <p v-if="item.deposit">
                                        <span>{{ $vuetify.lang.t('$vuetify.deposit') }}:</span> {{ item.deposit }}
                                    </p>
                                </div>
