		...
		<div class="contacts__content">
			<ul class="contacts_links">
				<li class="contacts_links__item" v-for="(contactsLink) in contactsLinks" :key="contactsLink.href">
					<a class="contacts_links__link" :href="contactsLink.href" target="_blank"><img class="contacts_links__img" :src="contactsLink.icon" alt="" loading="lazy"><span>{{ contactsLink.title }}</span></a>
				</li>
			</ul>
		</div>
	</div>
